...
const Input = ({ label, type, placeholder, formType }) => {
    ...
    return (
        <div className='flex flex-col gap-1 py-1 relative'>
            ...
            <input id={type} type={type==="password"?showPassword?"text":type:type} placeholder={placeholder} className='bg-white border w-full p-2 rounded-lg shadow-sm placeholder:text-sm' />
            {type === "password" ?
