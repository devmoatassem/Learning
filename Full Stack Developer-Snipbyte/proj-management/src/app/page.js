...
export default function Home() {
  return (
    ...
    <Hero />
      ...
      <DataSection data={datad} button={button2} logo={icon2} right={true} header={header1}/>
      <DataSection data={dated2} button={button1} logo={icon3} right={false} header={header1}/>
      <LastSection />
    </div>
